...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        JoinEntityDao.createTable(db, ifNotExists);
        More2BeanDao.createTable(db, ifNotExists);
        MoreBeanDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        JoinEntityDao.dropTable(db, ifExists);
        More2BeanDao.dropTable(db, ifExists);
        MoreBeanDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(JoinEntityDao.class);
        registerDaoClass(More2BeanDao.class);
        registerDaoClass(MoreBeanDao.class);
