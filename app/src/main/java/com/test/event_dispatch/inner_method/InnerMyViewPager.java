...
public class InnerMyViewPager extends ViewPager {

    public InnerMyViewPager(@NonNull Context context) {
        super(context);
    }

    public InnerMyViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
