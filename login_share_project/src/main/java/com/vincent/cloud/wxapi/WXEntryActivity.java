...
public class WXEntryActivity extends AppCompatActivity implements IWXAPIEventHandler{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ViseLog.d("当前WxEntryActivity的实例=" + this.toString());
    ...
    public void onResp(BaseResp baseResp) {
        ...
        final WXBaseRespEntity entity = JSON.parseObject(JSON.toJSONString(baseResp),WXBaseRespEntity.class);
        String result = "";
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                if(accessTokenEntity!=null){
                                    //缓存access_token
                                    mCacheWxDataUtils.putString(ACCESS_TOKEN,accessTokenEntity.getAccess_token());
                                    mCacheWxDataUtils.putString(OPEN_ID,accessTokenEntity.getOpenid());
                                    mCacheWxDataUtils.putString(REFRESH_TOKEN,accessTokenEntity.getRefresh_token());
                                    //获取用户信息
                                    getUserInfo(accessTokenEntity.getAccess_token(),accessTokenEntity.getOpenid());
                                }else {
                                    ViseLog.d("第一次获取失败");

                                    mCacheWxDataUtils.putString(ACCESS_TOKEN,"");
                                }
                            }
                        });
                break;
        ...
        OkHttpUtils.get()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        App.getShared().putString("nickName",nickName);
                        ViseLog.d("昵称:"+nickName);
