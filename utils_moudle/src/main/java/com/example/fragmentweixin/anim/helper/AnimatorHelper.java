package com.example.fragmentweixin.anim.helper;
...
import com.example.fragmentweixin.anim.FragmentAnimator;
...
public final class AnimatorHelper {
    ...
    /**
     * 设定的fragment动画传递到Activity的代理类后，紧接着传递到该方法上去，该方法是负责fragment的转场动画的帮助类
     * 即：初始化fragment的动画参数
     *
