...
public class New3Fragment extends BaseFragment {

	public static final String TAG = New3Fragment.class.getSimpleName();
	@Bind(R.id.viewpager_item_tv_id)
	TextView mTextView;
	
	public static New3Fragment NewInstance(Bundle bundle) {
		New3Fragment newFragment = new New3Fragment();
