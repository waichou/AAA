...
public class New4Fragment extends BaseFragment {

	public static final String TAG = New4Fragment.class.getSimpleName();
	@Bind(R.id.viewpager_item_tv_id)
	TextView mTextView;
	
	public static New4Fragment NewInstance(Bundle bundle) {
		New4Fragment newFragment = new New4Fragment();
